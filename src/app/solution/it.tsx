    ...
    <div className="w-full flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <p className="mb-4 text-gray-800 text-xs">
          Logica understand the importance of live information which we provide
          through our IT solutions. Clients have access to live portal
          information while offering system integration if necessary.
        </p>
