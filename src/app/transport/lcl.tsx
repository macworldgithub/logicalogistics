    ...
    <div className="w-full flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <p className="mb-4 text-gray-800 text-xs">
          At Logica we have the ability to offer end to end services, with
          trailer capabilities such as tailgate rigids, Semi and B-double
          tautliners and Mezzanine floor tautliners. With the assistance of our
          of Steel Oriented equipment and experienced operators we are also
          capable of handling any steel requirements you may have.
        </p>
