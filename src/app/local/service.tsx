    ...
    <div className="w-full flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <p className="mb-4 text-gray-800 text-xs">
          ...
          exactly when they need to be there. With a focus on minimizing delays
          and maximizing efficiency, our local container movement services help
          you stay ahead in a fast-paced market. Trust Logica to manage the
