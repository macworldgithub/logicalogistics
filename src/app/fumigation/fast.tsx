    ...
    <div className="w-full flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <p className="mb-4 text-gray-800 text-xs">
          Logica Logistics has a 4.6 ‘Approved Arrangement’ facility allowing us
          to offer fumigation on site, facilitating multiple containers daily.
          Understanding the delays fumigation can offer, Logica offer expedient
          turn arounds time.
        </p>
