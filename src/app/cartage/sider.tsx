  ...
  return (
    <div className="w-full flex flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-2xl">
        ...
        <p className="mb-4 text-gray-800 text-xs">
          Our fleet consists of a multitude of trailers such as side-loaders,
          and skels both retractable and non-retractable.
        </p>
        <p className="mb-4 text-gray-800 text-xs">
          Our fleet offers GPS tracking to ensure feedback and live accurate on
          time deliveries.
        </p>
        <p className="mb-8 text-gray-800 text-xs">
